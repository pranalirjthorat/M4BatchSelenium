...
public class DwsLIsterners extends BaseClassExtents implements ITestListener{
	public static ExtentSparkReporter spark;
	 ...
	 @Override
		...
		public void onStart(ITestContext result) {
			spark = new ExtentSparkReporter(".\\ExtentReports\\ExtentReport1.html");
			spark.config().setDocumentTitle("functional testing");
			spark.config().setReportName("Pranali");
